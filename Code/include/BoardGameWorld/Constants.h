...
//
// Based on: https://github.com/gauravahuja/Fanorona_AI/blob/master/Fanorona/Constants.h

#ifndef FANORONA_SERVER_CONSTANTS_H
#define FANORONA_SERVER_CONSTANTS_H
...
#endif //FANORONA_SERVER_CONSTANTS_H
