...
//
// Based on: https://github.com/gauravahuja/Fanorona_AI/blob/master/Fanorona/Board.cpp
...
//Stores the initial positions of the BLACK and WHITE stones in the matrix
...
//Returns the row and column and colour for given mouse position
